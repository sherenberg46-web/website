  ...
  const howToLd = {
    ...
    step: [
      ...
      },
      {
        ...
        position: 3,
        name: 'Получите код',
        text: 'Менеджер свяжется, подтвердит заказ и пришлёт код активации. Обычно около 30 минут.',
    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mt-16 prose-dark">
          ...
          <h2>Сколько ждать</h2>
          <p>
            В рабочее время — с 10:00 до 22:00 — код приходит обычно около 30 минут после
            оформления. Заказы, сделанные ночью, обрабатываем с утра. Предзаказы — отдельный
