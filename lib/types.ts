...
export interface Product {
   ...
   *
   * Товар лежит в базе дважды — украинская версия и турецкая, с разными
   * ценами и своими адресами, но с одинаковым содержимым. Поисковик считает
   * такие страницы дублями, а их в каталоге почти двадцать тысяч. Здесь
   * приходит id украинской версии, по нему страница ставит canonical.
   *
   * null — карточка сама основная. Приходит только с /products/{id}.
   */
